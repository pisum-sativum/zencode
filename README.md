...
## Runner Backend Integration (Quandary)
...
```bash
NEXT_PUBLIC_RUNNER_API_URL=http://localhost:8000
```

The integration uses:

- `POST /execute` to submit and wait
- `GET /result/{task_id}` polling when task status remains queued
